...
export async function GET(request: NextRequest) {
  try {
    ...
    console.log('📊 [PENILAI API] Found', penilais.length, 'penilais with jurusan filter:', jurusanId);
    console.log('📊 [PENILAI API] Penilai list:', penilais.map(p => ({
      id: p.id,
      nama: p.nama,
...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('📝 [PENILAI API] Creating user for penilai:', { nama, jenis, email, hasPassword: !!password });
